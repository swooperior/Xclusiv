                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control-file" type="file" name="file" id="file" value="{{$post->uri}}">
{{--                            if $post--}}
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="body_text" name="body_text">{!! $post->body !!}</textarea>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                                <label for="privacy">Privacy Setting </label>
                                <select id="privacy" name="privacy">
                                    <option value="0" {{$post->visibility == 0 ? 'selected' : ''}}>Exclusive</option>
                                    <option value="1" {{$post->visibility == 1 ? 'selected' : ''}}>Public</option>
                                    <option value="2" {{$post->visibility == 2 ? 'selected' : ''}}>Purchasable</option>
                                </select>
                            </div>
                            <div class="form-group col" id="content-price">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="number" step="0.01" id="price" name="price" value="{{$post->price}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
